...
public class ZybooksReader {
    ...
    static Logger logger = LogManager.getLogger(ZybooksReader.class);
            ...
            for(ArrayList<String> singleList: lineList){
                ...
                if(firstIteration){
                    ...
                    try {
                        ...
                        lorLister(studentNames,singleList, i);
...
//            e.printStackTrace();
    ...
    public static List<LearningObject> learningObjectsFromCSVList(List<String> csvfiles){
        ...
        for(String file: csvfiles){
            ArrayList<ArrayList<String>> lineList = ZybooksReader.staticLineToList(file);
            List<LearningObject> loList = new ArrayList<LearningObject>();
            loList = ZybooksReader.learningObjectsFromList(lineList.get(0));
    ...
    public void lorLister(ArrayList<String> studentNames, ArrayList<String> singleList, int i)throws NullPointerException{
        ...
        while (i < singleList.size() && i < learningObjectList.size() + 5) {
            LearningObject currentLearningObject = this.learningObjectList.get(i - 5);
