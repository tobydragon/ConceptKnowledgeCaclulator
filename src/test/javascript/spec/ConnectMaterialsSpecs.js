...
describe('ConnectMaterialsSpecs', function() {
    ...
    it('adding Resource Records with LearningMaterials', function(){
        ...
        expect(resourceRecords.length).toEqual(3);
        expect(resourceRecords[2].learningResourceId).toEqual('[ASSESSMENT] 1 [Cs1]');
    ...
    it('removing conceptIds from existing LearningResourceRecord', function(){
        expect(resourceRecords.length).toEqual(2);
        expect(resourceRecords[1].conceptIds.length).toEqual(1);
        updateResourceRecords(resourceRecords, '[INFORMATION] 2 [Cs1]', 'If-Statements');
