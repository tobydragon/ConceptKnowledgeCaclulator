...
public class ConceptGraphTest {
    ...
    public void linkLearningObjectsTest(){
        ...
        assertEquals("Q7",graph.findNodeById("B").getAssessmentItemMap().get("Q7").getId());
        ...
        assertEquals(true, graph.findNodeById("B").getAssessmentItemMap().get("Q7") == graph.findNodeById("C").getAssessmentItemMap().get("Q7"));
        assertEquals("Q7",graph.getAssessmentItemMap().get("Q7").getId());
