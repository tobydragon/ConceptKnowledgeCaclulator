...
public class ConceptGraphTest {
    ...
    public void calcTotalKnowledgeEstimate2(){
        ...
        ConceptGraph gr = graphs.getUserGraph("s1");
        Assert.assertEquals(13.5804, gr.calcTotalKnowledgeEstimate("all"), DataUtil.OK_FLOAT_MARGIN);

        ConceptGraph gr2 = graphs.getUserGraph("s2");
        Assert.assertEquals(11.4778, gr2.calcTotalKnowledgeEstimate("all"), DataUtil.OK_FLOAT_MARGIN);
